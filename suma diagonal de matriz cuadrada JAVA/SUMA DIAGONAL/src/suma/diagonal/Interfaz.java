...
/* 
* Resumen: se cra la clase Interfaz donde se inicializa losvalores de las cajas de texto

 */

public class Interfaz 
{
    private String uno,dos,tres,cuatro,cinco,seis,siete,ocho,nueve,cero;
